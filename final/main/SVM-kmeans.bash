...
./main.elf -repeats 1 -classifying SVM -clustering kmeans -train_data_path $DATASET2/PCA_train_data_32.csv -train_label_path $DATASET2/train_label.csv -test_data_path $DATASET2/PCA_test_data_32.csv -test_label_path $DATASET2/test_label.csv -normalize false -KNOWN_CNT 3 -UNKNOWN_CNT 2 -SVM_converge_lim 1e-7 -SVM_punishment 1 -kmeans_converge_lim 1e-7
