...
#./main.elf -repeats 1 -classifying KNN -clustering DBSCAN -train_data_path $DATASET2/AE_train_data_30.csv -train_label_path $DATASET2/train_label.csv -test_data_path $DATASET2/AE_test_data_30.csv -test_label_path $DATASET2/test_label.csv -normalize true -KNOWN_CNT 3 -UNKNOWN_CNT 2 -KNN_k 21 -KNN_maxdis 900 -KNN_problim 0.5 -KNN_method brute -SVM_converge_lim 1e-7 -SVM_punishment 1 -DBSCAN_minPts 32 -DBSCAN_eps 10 -kmeans_converge_lim 1e-7
