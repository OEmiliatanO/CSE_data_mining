...
./main.elf -repeats 1 -classifying SVM -clustering DBSCAN -train_data_path $DATASET1/train_data.csv -train_label_path $DATASET1/train_label.csv -test_data_path $DATASET1/test_data.csv -test_label_path $DATASET1/test_label.csv -normalize false -KNOWN_CNT 8 -UNKNOWN_CNT 5 -KNN_k 45 -KNN_maxdis 300 -KNN_problim 0.6 -KNN_method brute -SVM_converge_lim 1e-7 -SVM_punishment 1000 -DBSCAN_minPts 10 -DBSCAN_eps 500 -kmeans_converge_lim 1e-7
